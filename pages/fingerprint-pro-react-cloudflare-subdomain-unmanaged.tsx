  ...
  return (
    <FpjsProvider
      loadOptions={{
        ...
        scriptUrlPattern:
          "https://cloudflare-integration-unmanaged.martinmakarsky.com/VCwk5AbVKHxWeFtV/TSTNqkwF5uIl9Jpw?apiKey=<apiKey>&version=<version>&loaderVersion=<loaderVersion>", // ADDED (as is)
        endpoint:
          "https://cloudflare-integration-unmanaged.martinmakarsky.com/VCwk5AbVKHxWeFtV/EottbWHVCphdNjA2?region=eu", // CHANGED
      }}
