  ...
  return (
    <FpjsProvider
      loadOptions={{
        ...
        scriptUrlPattern:
          "https://cloudfront-v2-terraform.martinmakarsky.com/behavior-path/download-path?apiKey=<apiKey>&version=<version>&loaderVersion=<loaderVersion>",
        endpoint:
          "https://cloudfront-v2-terraform.martinmakarsky.com/behavior-path/result-path?region=eu",
      }}
