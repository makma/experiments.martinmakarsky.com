  ...
  return (
    <FpjsProvider
      loadOptions={{
        ...
        scriptUrlPattern:
          "https://cloudfront-distribution-proxy2.martinmakarsky.com/behavior-path/download-path?apiKey=<apiKey>&version=<version>&loaderVersion=<loaderVersion>",
        endpoint:
          "https://cloudfront-distribution-proxy2.martinmakarsky.com/behavior-path/result-path?region=eu",
      }}
