  ...
  useEffect(() => {
    (async () => {
      const fpPromise = FingerprintJS.load({
        ...
        scriptUrlPattern: "https://manual-cloudflare-integration.martinmakarsky.com/WORKER_PATH/AGENT_SCRIPT_DOWNLOAD_PATH?apiKey=<apiKey>&version=<version>&loaderVersion=<loaderVersion>",
        endpoint:"https://manual-cloudflare-integration.martinmakarsky.com/WORKER_PATH/GET_RESULT_PATH?region=eu",
      });
