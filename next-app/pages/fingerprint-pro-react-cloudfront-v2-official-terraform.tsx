  ...
  return (
    <FpjsProvider
      loadOptions={{
        ...
        scriptUrlPattern:
          "https://cloudfront-proxy-v2-official-terraform-module.martinmakarsky.com/download-path?apiKey=<apiKey>&version=<version>&loaderVersion=<loaderVersion>",
        endpoint:
          "https://cloudfront-proxy-v2-official-terraform-module.martinmakarsky.com/result-path?region=eu",
      }}
