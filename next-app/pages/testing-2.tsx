...
import { CLOUDFLARE_PROXY_INTEGRATION_ENDPOINT_TESTING_2, CLOUDFLARE_PROXY_INTEGRATION_SCRIPT_URL_PATTERN_TESTING_2, FINGERPRINT_PUBLIC_API_KEY_TESTING_2 } from "../shared/constants";
  ...
  useEffect(() => {
    (async () => {
      const fpPromise = FingerprintJS.load({
        apiKey: FINGERPRINT_PUBLIC_API_KEY_TESTING_2,
        scriptUrlPattern:
        CLOUDFLARE_PROXY_INTEGRATION_SCRIPT_URL_PATTERN_TESTING_2,
        endpoint:CLOUDFLARE_PROXY_INTEGRATION_ENDPOINT_TESTING_2,
